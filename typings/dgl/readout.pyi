...
__all__ = ['readout_nodes', 'readout_edges', 'sum_nodes', 'sum_edges', 'mean_nodes', 'mean_edges', 'max_nodes', 'max_edges', 'softmax_nodes', 'softmax_edges', 'broadcast_nodes', 'broadcast_edges', 'topk_nodes', 'topk_edges']
def readout_nodes(graph, feat, weight=..., *, op=..., ntype=...):
...
def readout_edges(graph, feat, weight=..., *, op=..., etype=...):
...
def sum_nodes(graph, feat, weight=..., *, ntype=...):
...
def sum_edges(graph, feat, weight=..., *, etype=...):
...
def mean_nodes(graph, feat, weight=..., *, ntype=...):
...
def mean_edges(graph, feat, weight=..., *, etype=...):
...
def max_nodes(graph, feat, weight=..., *, ntype=...):
...
def max_edges(graph, feat, weight=..., *, etype=...):
...
def softmax_nodes(graph, feat, *, ntype=...):
...
def softmax_edges(graph, feat, *, etype=...):
...
def broadcast_nodes(graph, graph_feat, *, ntype=...):
...
def broadcast_edges(graph, graph_feat, *, etype=...):
...
READOUT_ON_ATTRS = ...
def topk_nodes(graph, feat, k, *, descending=..., sortby=..., ntype=...): # -> tuple[Tensor, Unknown] | tuple[Unknown, Unknown]:
...
def topk_edges(graph, feat, k, *, descending=..., sortby=..., etype=...): # -> tuple[Tensor, Unknown] | tuple[Unknown, Unknown]:
