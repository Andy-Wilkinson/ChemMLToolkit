...
def rand_graph(num_nodes, num_edges, idtype=..., device=...): # -> DGLHeteroGraph:
...
def rand_bipartite(utype, etype, vtype, num_src_nodes, num_dst_nodes, num_edges, idtype=..., device=...): # -> DGLHeteroGraph:
