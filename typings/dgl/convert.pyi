...
__all__ = ['graph', 'bipartite', 'hetero_from_relations', 'hetero_from_shared_memory', 'heterograph', 'create_block', 'block_to_graph', 'to_heterogeneous',
           'to_hetero', 'to_homogeneous', 'to_homo', 'from_scipy', 'bipartite_from_scipy', 'from_networkx', 'bipartite_from_networkx', 'to_networkx']


def graph(data: Union[Tuple[Tensor, Tensor],
                      Tuple[str, Tuple[Tensor, Tensor]],
                      Tuple[str, Tuple[Tensor, Tensor, Tensor]]],
          ntype: Optional[str] = ...,
          etype: Optional[str] = ...,
          *,
          ...
          idtype: Any = ...,
          device: Any = ...,
          row_sorted: Optional[bool] = ...,
          col_sorted: Optional[bool] = ...,
          **deprecated_kwargs: Any) -> DGLGraph:
...
# -> NoReturn:
def bipartite(data, utype=..., etype=..., vtype=..., num_nodes=..., card=..., validate=..., restrict_format=..., **kwargs):
...
# -> DGLHeteroGraph:
def heterograph(data_dict, num_nodes_dict=..., idtype=..., device=...):
...
def to_heterogeneous(G, ntypes, etypes, ntype_field=..., etype_field=..., metagraph=...):
    ...
    * Calling :func:`~dgl.to_homogeneous` then calling :func:`~dgl.to_heterogeneous` again
    ...
    Graph(num_nodes={'activity': 3, 'developer': 2, 'game': 2, 'user': 2},
          num_edges={('developer', 'develops', 'game'): 2,
                      ('user', 'develops', 'activity'): 2},
    ...
    Graph(num_nodes=9, num_edges=4,
          ...
          edata_schemes={'_TYPE': Scheme(shape=(), dtype=torch.int64),
                         '_ID': Scheme(shape=(), dtype=torch.int64)})
    >>> g.ndata
    {'_TYPE': tensor([0, 0, 0, 1, 1, 2, 2, 3, 3]),
                     '_ID': tensor([0, 1, 2, 0, 1, 0, 1, 0, 1])}
...
def to_homogeneous(G, ndata=..., edata=..., store_type=..., return_count=...):
    ...
    * Calling :func:`~dgl.to_homogeneous` then calling :func:`~dgl.to_heterogeneous` again
    ...
    >>> g.ndata
    {'_TYPE': tensor([0, 0, 0, 1, 1, 2, 2]),
                     '_ID': tensor([0, 1, 2, 0, 1, 0, 1])}
...
# -> tuple[DGLHeteroGraph, Unbound | list[Unknown], Unbound | list[Unknown]] | DGLHeteroGraph:
def to_homo(G):
...
# -> DGLHeteroGraph:
def from_scipy(sp_mat, eweight_name=..., idtype=..., device=...):
...
# -> DGLHeteroGraph:
def bipartite_from_scipy(sp_mat, utype, etype, vtype, eweight_name=..., idtype=..., device=...):
...
# -> DGLHeteroGraph:
def create_from_edges(sparse_fmt, arrays, utype, etype, vtype, urange, vrange, row_sorted=..., col_sorted=...):
