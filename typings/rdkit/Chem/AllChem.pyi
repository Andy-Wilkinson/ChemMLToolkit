...
"""
logger = ...
def TransformMol(mol, tform, confId=..., keepConfs=...): # -> None:
...
def ComputeMolShape(mol, confId=..., boxDim=..., spacing=..., **kwargs):
  """ returns a grid representation of the molecule's shape
    """
  ...

def ComputeMolVolume(mol, confId=..., gridSpacing=..., boxMargin=...):
...
def GetConformerRMS(mol, confId1, confId2, atomIds=..., prealigned=...): # -> Any:
...
def GetConformerRMSMatrix(mol, atomIds=..., prealigned=...): # -> list[Unknown]:
...
def EnumerateLibraryFromReaction(reaction, sidechainSets, returnReactants=...): # -> Generator[ProductReactants | Unknown, None, None]:
...
def ConstrainedEmbed(mol, core, useTethers=..., coreConfId=..., randomseed=..., getForceField=..., **kwargs):
