...
class AtomFeaturiser:
    ...
    A number of features are implemented,
        ...
        - is_ring3: If the atom is in a 3-membered ring (0 or 1)
        - is_ring4: If the atom is in a 4-membered ring (0 or 1)
        - is_ring5: If the atom is in a 5-membered ring (0 or 1)
        - is_ring6: If the atom is in a 6-membered ring (0 or 1)
        - is_ring7: If the atom is in a 7-membered ring (0 or 1)
